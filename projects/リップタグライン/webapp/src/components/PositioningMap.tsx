...
interface CustomTooltipProps {
  active?: boolean
  payload?: Array<{ payload: LipTagline }>
}
    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={500}>
        <ScatterChart margin={{ top: 20, right: 40, bottom: 40, left: 40 }}>
          ...
          >
            <Label value="← 色持ち・機能訴求　　　　　　発色・感性訴求 →" position="bottom" offset={10} style={{ fontSize: 13, fill: "#6b7280" }} />
          </XAxis>
          <YAxis
            type="number"
            dataKey="y"
            ...
            tick={{ fontSize: 11, fill: "#9ca3af" }}
          >
            <Label value="← ナチュラル　　　　華やか →" angle={-90} position="left" offset={10} style={{ fontSize: 13, fill: "#6b7280" }} />
          </YAxis>
